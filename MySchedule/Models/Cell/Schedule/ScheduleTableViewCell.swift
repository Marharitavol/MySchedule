...
class ScheduleTableViewCell: UITableViewCell {
    ...
    let lessonType = UILabel(text: "", font: .avenirNexDemiBoldt14(), alignment: .left)
    let buldingLabel = UILabel(text: "Building", font: .avenirNext14(), alignment: .right)
    let lessonBulding = UILabel(text: "", font: .avenirNexDemiBoldt14(), alignment: .left)
    let audLabel = UILabel(text: "Audience", font: .avenirNext14(), alignment:  .right)
    let lessonAud = UILabel(text: "", font: .avenirNexDemiBoldt14(), alignment: .left)
