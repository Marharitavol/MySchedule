...
class ContactsTableViewCell: UITableViewCell {
    ...
    let nameLabel = UILabel(text: "Dog", font: .avenirNext20(), alignment: .left)
    let phoneLabel = UILabel(text: "+380181057952 ", font: .avenirNext14(), alignment: .left)
    let mailLabel = UILabel(text: "Dog@gmail.com", font: .avenirNext14(), alignment: .left)
